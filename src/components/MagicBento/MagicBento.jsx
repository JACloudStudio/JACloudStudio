...
const cardData = [
  {
    color: '#060010',
    title: 'Analytics',
    description: 'Track traffic, uptime, and performance metrics to understand how your website is actually performing.',
    label: 'Insights'
  },
  {
    color: '#060010',
    title: 'Dashboard',
    description: 'A single, centralized view to monitor deployments, health status, and usage in real time.',
    label: 'Overview'
  },
  {
    color: '#060010',
